...
/*
 * demo-php 四种排序算法的时间与内置的sort排序比较
 * 3000个元素，四种算法的排序所用的时间比较
 * 冒泡排序用时：1015.7518386841ms
 * 选择排序用时：432.56616592407ms
 * 插入排序用时：340.39902687073ms
 * 快速排序用时：18.088102340698ms
 * sort排序用时：0.6558895111084ms
 * 归并排序用时：21.974802017212ms
 *
 * */
...
* 算法适用于少量数据的排序，最差时间复杂度为O(n^2)，最优时间复杂度为O(nlogn)。是稳定的排序方法。
* */
